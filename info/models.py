...
test_name = (
    ...
    ('Tutorial', 'Tutorial'),
    #('Total Internal Marks', 'Total Internal Marks'),
    #('Semester End Exam', 'Semester End Exam'),
)
...
class Marks(models.Model):
    ...
    name = models.CharField(max_length=50, choices=test_name, default='Internal 1')
    ...
    def total_marks(self):
        if self.name == 'Semester End Exam':
            return 100
        elif self.name == 'Assignment' or self.name == 'Tutorial':
            return 5
        return 20
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                    ...
                    sc.save()
                    sc.marks_set.create(name='Internal 1')
                    sc.marks_set.create(name='Internal 2')
                    sc.marks_set.create(name='Assignment')
                    sc.marks_set.create(name='Tutorial')
                    #sc.marks_set.create(name='Total Internal Marks')
